...
#define TI_INDICATOR_CROSSACTION_INDEX 105
int ti_crossaction_start(TI_REAL const *options);
int ti_crossaction(int size, TI_REAL const *const *inputs, TI_REAL const *options, TI_REAL *const *outputs);
...
{"crossroi", "Cross Signals ROI", ti_crossroi_start, ti_crossroi, 0, TI_TYPE_SIMPLE, 3, 1, 1, {"fast","slow","prices",0}, {"fee",0}, {"roi",0}, 0, 0, 0},
{"crossaction", "Cross Signals Action", ti_crossaction_start, ti_crossaction, 0, TI_TYPE_SIMPLE, 2, 0, 1, {"fast","slow",0}, {"",0}, {"action",0}, 0, 0, 0},
